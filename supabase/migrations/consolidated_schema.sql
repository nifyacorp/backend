--
-- NIFYA Consolidated Schema Definition
-- Created: April 1, 2025
--
-- This consolidated schema file replaces the previous incremental migrations
-- and serves as a single source of truth for the database structure.
--

-- First, drop everything to start clean (only for full resets)
-- DO NOT UNCOMMENT THIS IN PRODUCTION ENVIRONMENTS UNLESS PERFORMING A FULL RESET
...
SELECT register_schema_version('20250402000000', 'Initial consolidated schema');